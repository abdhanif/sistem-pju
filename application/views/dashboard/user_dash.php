            ...
            <div class="container col-md">
                <div class="row">
                    ...
                    <!-- <div class="col text-right">
                        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#tambahdonatur"></i> Statistik Data</a>
                    </div> -->
                </div>
            </div>
        </div>
                        ...
                        ?>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card border-left-info shadow">
                                    ...
                                    <div class="card-footer bg-white d-flex align-items justify-content-between">
                                        <a class="small text-info">View Details</a>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card border-left-success shadow">
                                    ...
                                    <div class="card-footer bg-white d-flex align-items justify-content-between">
                                        <a class="small text-success">View Details</a>
                                        <i class="fas fa-angle-right"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card border-left-danger shadow">
                                    ...
                                    <div class="card-footer bg-white d-flex align-items justify-content-between">
                                        <a class="small text-danger">View Details</a>
                                        <i class="fas fa-angle-right"></i>
                                    </div>
                                </div>
                            </div>
