            ...
            <div class="card-body">
                <div class="container col-md">
                    <form class="user" method="post" action="<?= base_url('C_data_pju/update') ?>">
                        <input type="hidden" class="form-control" name="id_pju" value="<?php echo $dp->id_pju; ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="exampleFormControlSelect1">Kode Kelompok</label>

                                <select class="form-control" id="kode_kelompok" name="kode_kelompok" value="<?php echo $dp->kode_kelompok; ?>">
                                    <option value="">-Pilih Satu-</option>
                                    <?php
                                    foreach ($data_kelompok as $d) {
                                    ?>
                                        <?php if ($d->kode_kelompok == $dp->kode_kelompok) : ?>
                                ...
                                <input type="text" class="form-control" id="kode_pju" name="kode_pju" value="<?php echo $dp->kode_pju; ?>">
                                <?= form_error('kode_pju', ' <small class="text-danger pl-3">', '</small>'); ?>

                                </br>

                                <label class="form-label">Alamat</label>
                                <input type="text" class="form-control form-control" id="alamat_pju" name="alamat_pju" value="<?php echo $dp->alamat_pju; ?>">
                                <?= form_error('alamat_pju', ' <small class="text-danger pl-3">', '</small>'); ?>
                                </br>

                                <label class="form-label">Latitude</label>
                                <input type="text" class="form-control form-control" id="lat" name="lat" value="<?php echo $dp->lat; ?>">
                                <?= form_error('lat', ' <small class="text-danger pl-3">', '</small>'); ?>

                                </br>

                                <label class="form-label">Longitude</label>
                                <input type="text" class="form-control form-control" id="lng" name="lng" value="<?php echo $dp->lng; ?>">
