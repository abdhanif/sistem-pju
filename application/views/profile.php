           ...
           <?php
            ...
            ?>
               <div class="col-md-3 border-right">
                   <div class="d-flex flex-column align-items-center text-center p-3 py-5"> <img class="rounded-circle mt-5" src="<?= base_url('assets/') ?>img/undraw_profile.svg">
                       <span class="font-weight-bold"><?php echo $row->name ?></span><span class="text-black-50">amelly12@bbb.com</span><span> </span>
                   </div>
               </div>
