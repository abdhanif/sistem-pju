                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" readonly placeholder="<?php echo $dt->kecamatan; ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <div class="font-weight-bold">
                                    <label for="inputWA">Kelurahan</label>
                                </div>
                                <input type="text" class="form-control" readonly placeholder="<?php echo $dt->kelurahan; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" readonly rows="1" placeholder="<?php echo $dt->alamat; ?>"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" readonly rows="3" placeholder="<?php echo $dt->laporan; ?>"></textarea>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="font-weight-bold">
                                ...
                                <input type="text" class="form-control" readonly placeholder="<?php echo $dt->verifikasi; ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <div class="font-weight-bold">
                                    <label for="inputWA">Dibuat</label>
                                </div>
                                <input type="text" class="form-control" readonly placeholder="<?php echo $dt->create_at; ?>">
                            </div>
                        </div>
