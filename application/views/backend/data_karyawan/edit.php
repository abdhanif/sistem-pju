        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="font-weight-bold" style="color: #5777ba">EDIT DATA KARYAWAN</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="status_karyawan" name="status_karyawan"
                                    value="<?php echo set_value('status_karyawan'); ?>">
