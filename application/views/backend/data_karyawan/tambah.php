                    ...
                    <form class="user" method="post" action="<?= base_url('C_Karyawan/tambah') ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control" id="nik" name="nik"
                                    value="<?= set_value('nik'); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control" id="nama" name="nama"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control" id="no_tlpn" name="no_tlpn"
                                    value="<?= set_value('no_tlpn'); ?>">
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control form-control" id="alamat" name="alamat"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control" id="jabatan" name="jabatan"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="status_karyawan" name="status_karyawan"
                                    value="<?= set_value('status_karyawan'); ?>">
                                    <option>-Pilih-</option>
