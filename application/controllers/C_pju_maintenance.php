<?php
class C_pju_maintenance extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/pju_maintenance/index', $data);
        $this->load->view('backend/pju_maintenance/tambah', $data);
        $this->load->view('backend/pju_maintenance/edit');
        $this->load->view('backend/pju_maintenance/form_filter');
